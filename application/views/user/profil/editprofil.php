                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('user/edit'); ?>">
                            ...
                            <div class="form-group row">
                                <label for="bb" class="col-sm-3 col-form-label">Berat Badan<small style="color:red">*</small></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="bb" name="bb" value="<?= $user['bb']; ?>">
